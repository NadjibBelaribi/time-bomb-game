...
"border-radius:20px;"));
        ...
        gridLayout->addItem(verticalSpacer_28, 3, 2, 1, 1);
...
"}"));
        ...
        sizePolicy2.setHeightForWidth(networkMenu->sizePolicy().hasHeightForWidth());
        networkMenu->setSizePolicy(sizePolicy2);
